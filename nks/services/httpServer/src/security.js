...
module.exports = {
	...
	"DiffieHellman": {
		 ...
		 */
		encrypt: function (str) {
			var encoder = new NodeRSA(NKDiffieHellman.public_pkcs8, { encryptionScheme: 'pkcs1' });
		...
		decrypt: function (str) {
			var decoder = new NodeRSA(NKDiffieHellman.private_pkcs1, { encryptionScheme: 'pkcs1' });
		 ...
		 */
		sign: function (str) {
			var encoder = new NodeRSA(NKDiffieHellman.private_pkcs1, { encryptionScheme: 'pkcs1' });
		...
		verify: function (str, signature) {
			var decoder = new NodeRSA(NKDiffieHellman.public_pkcs8, { encryptionScheme: 'pkcs1' });
